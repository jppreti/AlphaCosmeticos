...
public class MockProdutoDAO implements IProdutoDAO {
    ...
    static {
        ...
        //Masculino->Fragrancias 
        produtos.add(new ProdutoEntity((long) 4, "Desodorante","Colonia Spray","Alpha", (float) 10.0, (float) 5.0, (float) 2.0, (float) 4.0, (float) 8.0, cat.getById((long) 6), 50,12,30, fornecedor.getById((long) 3)));
        
        //Masculino->Barbear
        produtos.add(new ProdutoEntity((long) 5, "Loção pós barba","","Alpha", (float) 10.0, (float) 5.0, (float) 2.0, (float) 4.0, (float) 8.0, cat.getById((long) 7), 50,12,30, fornecedor.getById((long) 3)));
        
        //Infantil->Colonia
        produtos.add(new ProdutoEntity((long) 6, "Kit de colonias","Para meninas","Avon", (float) 10.0, (float) 5.0, (float) 2.0, (float) 4.0, (float) 8.0, cat.getById((long) 8), 50,12,30, fornecedor.getById((long) 3)));
